...
trigger T02_AccountBillingToShipping on Account (before insert, before update) {
...
Trigger Context Variables with Scenario
...
new - this sObject list is only available in insert, update and undelete triggers, and the records can only be modified in before triggers.
- returns a list of new version of sObject records,
